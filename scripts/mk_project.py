...
def init_project_def():
    ...
    add_lib('qsolver', ['solver', 'normal_forms', 'pattern'], 'solver/adapters/quantifier')
    ...
    add_lib('bounded_quantifiers', ['tactic', 'rewriter', 'arith_tactics'], 'mcsat/bounded_quantifiers')
    ...
    # MCSat components
    add_lib('mcsat', ['pre_solver', 'qsolver', 'core_tactics', 'arith_tactics'])
