...
/*
  ADD_TACTIC("add_bounds", "add bounds to unbounded variables (under approximation).", "mk_add_bounds_tactic(m, p)")
  ADD_PROBE("is_unbounded", "true if the goal contains integer/real constants that do not have lower/upper bounds.", "mk_is_unbounded_probe()")
*/
