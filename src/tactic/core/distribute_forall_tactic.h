...
/*
  ADD_TACTIC("distribute_forall", "distribute forall over conjunctions.", "mk_distribute_forall_tactic(m, p)")
*/

MK_SIMPLE_TACTIC_FACTORY(distribute_forall_tactic_factory, mk_distribute_forall_tactic(m, p));
